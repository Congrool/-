					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse">
							<div class="panel-body">
								<div><a href="#"><b>快讯</b></a></div>
								<div><a href="tiyu2.jsp">赛事</a></div>
			...
			<div class="col-md-10	">
				<div class="panel panel-default">
					<ul style="margin-top:20px;margin-left:20px;font-size:18px;">
						<li><a href="NewsDetail?newsid=112">齐达内谈贝尔纳瓦斯去留，承认防守有问题！</a></li><br/>
						<li><a href="NewsDetail?newsid=113">意大利特雷维索篮球俱乐部有意安东尼-布朗</a></li><br/>
