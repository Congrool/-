...
//		super.service(req, resp);
		...
		try {
			...
			/* System.out.println(comm[0].getNewsID()); */
			//获得uid对应用户名
			...
			String[][] commentAndUsername = new String[comm.length][6];
 			...
 			req.setAttribute("comments", commentAndUsername);
 			req.setAttribute("newsid", newsid);
			/*
			 * for(int i=0;i<commentAndUsername.length;i++) { for(int
			 * j=0;j<commentAndUsername[0].length;j++)
			 * System.out.println(commentAndUsername[i][j]); }
			 */
			//TODO: page jsp path
